"""
File to extract Youtube transcripts via Youtube video ID (text after "v=" in Youtube URL)
Pipes directly in via stdin and outputs to stdout
Uses a proxy to avoid AWS and Youtube API clash
Uses shared class credentials in .env (.gitignore-d)
"""
#!/usr/bin/env python3
import sys
import os
...
def main():
    ...
    Pipes Youtube IDs to find transcripts of video
    Has a few error checks around, logs errors in log
    """
