...
EXECUTE IMMEDIATE FROM @DS5111_GIT_STAGE/branches/LAB10_dbt_expectations/transform/01_stg_youtube_transcripts.sql
EXECUTE IMMEDIATE FROM @DS5111_GIT_STAGE/branches/LAB10_dbt_expectations/transform/02_dim_videos.sql
EXECUTE IMMEDIATE FROM @DS5111_GIT_STAGE/branches/LAB10_dbt_expectations/transform/03_fct_entities.sql
